...
//     {
//     
//         [SerializeField] private SingleMovementResponder[] gates = new SingleMovementResponder[2];
//     
...
//         {
//             // _animsFinished = 0;
//             _startGizmoLineX.y = _startGizmoLineY.x = float.PositiveInfinity;
//             _endGizmoLineX.y = _endGizmoLineY.x = float.NegativeInfinity;
//         }
//     
//         void Start()
//         {
...
//         }
//
//         private bool CanChangeCameras()
//         {
//             return (_blueOne.position.x < -changingPointX && _redOne.position.x > changingPointX) 
//                    && (_blueOne.position.y > changingPointY && _redOne.position.y > changingPointY) 
//                    && ()
//         }
//
//
...
//             _endGizmoLineY.y = _endGizmoLineY.y = changingPointY; 
