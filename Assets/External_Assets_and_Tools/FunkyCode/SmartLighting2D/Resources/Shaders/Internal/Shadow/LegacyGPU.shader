        ...
        Pass
        {
            ...
            float2 ClosestPointOnLine (float2 vA, float2 vB) {
                ...
                void geom(triangle v2f input[3], inout TriangleStream<v2f> OutputStream)
                {
                    ...
                    fixed4 blackColor = float4(0, 0, 0, 1 - translucency);
                    fixed4 whiteColor = float4(1, 1, 1, 1 - translucency);
                    ...
                    if (outerAngle > 0.1f) {
                        ...
                        vertice3.uv = float2(1, 1);
                        vertice0.uv = float2(0, 1);
                        v0.uv = float2(0, 0); 

                        vertice4.uv = float2(1, 1);
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                return fixed4(0, 0, 0, (1 - color.r) * i.color.a);
            }
            ENDCG
        }
    }
