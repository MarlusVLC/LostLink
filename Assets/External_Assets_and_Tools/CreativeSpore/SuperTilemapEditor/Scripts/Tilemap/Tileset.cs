        ...
        public void Slice()
        {
            ...
            if (AtlasTexture != null)
            {
                ...
                if (uInc > 0 && vInc > 0)
                {
                    ...
                    if (m_tilesetHeight == 0)
                        Debug.LogError("No tiles were sliced, maybe because the tile size is greater than the texture size. Tile Height = " + TilePxSize.y + " Texture Height = " + AtlasTexture.height);
                    else
